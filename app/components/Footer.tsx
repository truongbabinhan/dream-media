...
export const Footer = () => {
  return (
    <div className="w-full flex flex-col relative justify-center items-center pt-[100px] pb-[10px] max-sm:py-[50px]">
      ...
      />
      <p className="text-[18px] text-center mt-[100px] mb-[15px] max-sm:text-[12px] max-sm:mt-[50px]">
        WANT TO WORK TOGETHER, WORK WITH US, OR FOR US?
      </p>
      <p className="text-[11px] text-center mb-[30px]">
      ...
      <div className="text-center mb-[70px] max-sm:mb-[20px]">
        <p className="text-[15px] mb-[30px] max-sm:text-[10px] max-sm:mb-[10px]">
          FOLLOW US:
        </p>
      ...
      <p className="text-[11px] max-w-[920px] text-center mb-[130px] max-sm:mb-[60px] max-sm:text-[8px] max-sm:px-10">
      ...
      <p className="text-[11px] text-center max-sm:text-[8px]">
